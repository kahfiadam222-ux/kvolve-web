          ...
          {tab === "custom" ? (
            <div className="max-w-sm animate-fade-in">
              ...
              <button
                ...
                className="mt-5 w-full rounded-xl bg-gradient-to-r from-teal-300 via-sky-300 to-violet-300 px-4 py-2.5 text-sm font-semibold text-slate-950 transition-all hover:shadow-glow active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-35 disabled:hover:shadow-none"
              >
                Buat Kanvas Baru
              </button>
            </div>
